...
30 20 * * * cd /home && sh run.sh >> logs/run.log 2>> logs/run_err.log
...
45 00,02,13,17 * * * cd /home && sh tweet.sh random_item >> logs/twt.log 2>> logs/twt_err.log
30 11,15,22 * * * cd /home && sh tweet.sh random_comparison >> logs/twt.log 2>> logs/twt_err.log
01 8 * * * cd /home/utils/ && sh reset_data.sh >> ../logs/run.log 2>> ../logs/run_err.log
